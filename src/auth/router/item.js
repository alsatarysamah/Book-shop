...
itemRouter.get("/item", bearer, acl("read"), getAll);
itemRouter.post("/item", bearer, acl("create"), creatRecord);
itemRouter.put("/item/:id", bearer, acl("update"), updating);
itemRouter.delete("/item/:id", bearer, acl("delete"), deleting);
itemRouter.get("/item/:id", bearer, acl("read"), getOneRecored);
